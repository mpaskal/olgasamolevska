const articles = [
  {
    ...
    year: "2019",
    date: "20 грудня, 2019",
    image: "_assets/images/makarenka.jpg",
    description:
  ...
  },
  {
    ...
    year: "2019",
    date: "26 квiтня, 2019",
    image: "_assets/images/movchanya.jpg",
  ...
  },
  {
    ...
    year: "2017",
    date: "20 жовтня 2017",
    image: "_assets/images/gorbachov.jpg",
    description:
  ...
  },
  {
    ...
    image: "_assets/images/vazka.jpg",
    description:
  ...
  },
  {
    ...
    year: "2013",
    date: "30 серпня 2013",
    image: "_assets/images/phenomen.jpg",
    description:
...
function setSections() {
  ...
  years.map((publishedYear, index) => {
    ...
    document.querySelector(`#${CSS.escape(h2ArtIndex)}`).innerHTML =
      publishedYear;
    ...
    yearArticles.map((yearArticle, index) => {
      ...
      document
        .querySelector(`#${CSS.escape(divSubArtIndex)}`)
        .appendChild(card);
      ...
      document
        .querySelector(`#${CSS.escape(cardIndex)}`)
        .appendChild(titleLink);

      let createText = document.createTextNode(yearArticle.title);
      document
        .querySelector(`#${CSS.escape(titleLinkIndex)}`)
      ...
      document
        .querySelector(`#${CSS.escape(cardBodyIndex)}`)
        .appendChild(imgLink);
      ...
      document
        .querySelector(`#${CSS.escape(imgLinkIndex)}`)
        .appendChild(cardImg);
      ...
      document.querySelector(`#${CSS.escape(cardTextIndex)}`).innerHTML =
        yearArticle.description;
    });
  });
}
